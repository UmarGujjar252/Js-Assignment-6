...
const greetUser = () => {
    ...
    if (hours >= 4 && hours < 12) {
        ...
        output.innerHTML = "<span style='color:green'>Good Morning </span> " + "<span style='color:green'>" + " " + userName + "</span>";
    }
    else if (hours >= 12 && hours < 16) {
        // greetingMessage += " Afternoon " + userName
        output.innerHTML = "<span style='color:green'>Good Afternoon </span> " + "<span style='color:green'>" + " " + userName + "</span>";
    }
    else if (hours >= 16 && hours < 20) {
        // greetingMessage += " Evening " + userName
        output.innerHTML = "<span style='color:green'>Good Evening </span> " + "<span style='color:green'>" + " " + userName + "</span>";
    }
    else {
        // greetingMessage += " Night " + userName ;
        output.innerHTML = "<span style='color:green'>Good Night </span> " + "<span style='color:green'>" + " " + userName + "</span>";
